    ...
    R.app = function() {
        ...
        var mainLogo = $('.logo'),
            ...
            homeAction = function() {
                ...
                logo.removeClass('js-bounceInDown');
                menu.removeClass('js-fadeInRight');
                heroInitLeft.removeClass('js-rotateInDownRight');
                heroInitRight.removeClass('js-rotateInDownLeft');

                logo.addClass('js-bounceInDown');

                if (!menu.hasClass('js-fadeInRight')) {
                    setTimeout(function() {
            ...
            contactActive = function() {
                ...
                name.removeClass('is-bounceIn');
                email.removeClass('is-bounceIn');
                subject.removeClass('is-bounceIn');
                messages.removeClass('is-bounceIn');
                submit.removeClass('is-bounceIn');
